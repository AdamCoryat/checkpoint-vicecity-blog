<template>
  <div class="blog-details container-fluid" id="blog-details">
    <div class="row d-flex justify-content-center">
      <div class="col-3">
        <img class="text-center m-4 shadow border-success rounded" src="../assets/detail1.jpg" style="width: 21vw" alt="detailpic">
      </div>
      <div class="col-12 col-md-6">
        <div class="my-3 shadow card blog text-success border border-success">
          <div v-if="editToggle">
         <div class="card-body px-lg-5 pt-0">
            <form @submit.prevent="editBlog" class="md-form">
               ...
               <button class="btn btn-success btn-rounded my-1" type="submit">Save</button>
            </form>
       </div>
      </div>
          <div class="card-body">
          ...
          <div class="card-body border border-success flex-wrap inline">
            ...
            <input
              ...
              type="text"
              id="materialSaveFormName"
              class="form-control blog border border-success text-success"
      ...
      <div class="col-3">
        <img class="text-center m-4 shadow border-success rounded" src="../assets/detial2.jpg" style="width: 20vw" alt="">
    </div>
  </div>
  </div>
</template>
